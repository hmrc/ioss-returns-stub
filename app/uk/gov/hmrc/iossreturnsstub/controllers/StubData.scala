...
object StubData {
  ...
  val fullMonthsResponse: EtmpObligations = EtmpObligations(obligations = Seq(EtmpObligation(
    obligationDetails = Seq(
      EtmpObligationDetails(
        status = EtmpObligationsFulfilmentStatus.Fulfilled,
        periodKey = "24AL"
  ...
  val moreThanSixYearsFulfilledReturns: EtmpObligations = EtmpObligations(obligations = Seq(EtmpObligation(
    obligationDetails = Seq(
      EtmpObligationDetails(
        status = EtmpObligationsFulfilmentStatus.Fulfilled,
        periodKey = "24AA"
  ...
  val periodsBeforeQuarantine: EtmpObligations = {
    val firstMonthPeriod = getEtmpStringFromDate(LocalDate.now().minusYears(2).minusMonths(2))
    val secondMonthPeriod = getEtmpStringFromDate(LocalDate.now().minusYears(2).minusMonths(1))
    val thirdMonthPeriod = getEtmpStringFromDate(LocalDate.now().minusYears(2))
    ...
    EtmpObligations(obligations =
      Seq(EtmpObligation(
        obligationDetails = Seq(
          EtmpObligationDetails(
            status = EtmpObligationsFulfilmentStatus.Fulfilled,
            periodKey = firstMonthPeriod
          ),
          EtmpObligationDetails(
            status = EtmpObligationsFulfilmentStatus.Fulfilled,
            periodKey = secondMonthPeriod
          ),
        EtmpObligationDetails(
          status = EtmpObligationsFulfilmentStatus.Fulfilled,
          periodKey = thirdMonthPeriod
        )
      )
      ))
    )
  ...
  val twoFulfilledDifferentYears: EtmpObligations = EtmpObligations(obligations = Seq(EtmpObligation(
    obligationDetails = Seq(
      EtmpObligationDetails(
        status = EtmpObligationsFulfilmentStatus.Fulfilled,
        periodKey = "25AA"
  ...
  val twoFulfilledIntExcluded: EtmpObligations = EtmpObligations(obligations = Seq(EtmpObligation(
    obligationDetails = Seq(
      EtmpObligationDetails(
        status = EtmpObligationsFulfilmentStatus.Fulfilled,
        periodKey = "25AA"
  ...
  val oneFulfilledOneOpenIntExcluded: EtmpObligations = EtmpObligations(obligations = Seq(EtmpObligation(
    obligationDetails = Seq(
      EtmpObligationDetails(
        status = EtmpObligationsFulfilmentStatus.Fulfilled,
        periodKey = "25AA"
